...
namespace GameEngine
{
    class Blinky : PacmanGhost
    {
        ...
        public Blinky(float X, float Y, MicroGame microGame, Vector2f framemin, Vector2f framemax) : base(X, Y, microGame, framemin, framemax)
        {
            bitmap = new Bitmap("Pacman/blinky.png");
        ...
        public override void Function()
        {
            if (microGame.gameState == MicroGame.GameState.Playing)
            {
                ...
                int randomdirection = random.Next(0, 150);
