...
namespace GameEngine
{
    class Pinky : PacmanGhost
    {
        ...
        public Pinky(float X, float Y, MicroGame microGame, Vector2f framemin, Vector2f framemax) : base(X, Y, microGame, framemin, framemax)
        {
            bitmap = new Bitmap("Pacman/pinky.png");
            spriteStruct = new SpriteStruct(bitmap, 0, 2, 14, 14, 2, 4, 0.3f, 2);
